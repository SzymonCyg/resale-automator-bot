  ...
  function injectSidebar() {
    ...
    root.innerHTML = `
      <style>
        ...
        #vm-sidebar-root.open #vm-handle { left:12px; right:auto; top:14px; height:40px; width:40px; transform:none; border-radius:10px; box-shadow:0 4px 12px rgba(0,0,0,.4); }
